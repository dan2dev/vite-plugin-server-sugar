...
See
[Runtime and deployment](./docs/runtime-and-deployment.md#deployment-checklist)
...
- [`examples/basic-worker`](./examples/basic-worker) — `platform: "cloudflare-worker"` on `workerd`
